...
const Profile = () => {
    ...
    return (
        <div className='min-h-[65vh]'>
            ...
            {
                user ? (
                    <div className='rounded-4xl my-[10vh] max-w-[65%] mx-auto h-[45%] bg-[#ff3700c0] p-12 shadow-2xl shadow-[#ff360080] flex flex-col lg:flex-row justify-around gap-3'>
                        <div className='border p-3 w-fit rounded-full bg-red-200 flex items-center'>
